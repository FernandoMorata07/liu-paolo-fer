  ...
  return (
    <section className="legalNoticeGlobal">
      ...
      <p className="legalNoticeP">
        ...
        actividad. Los datos no se cederán a terceros salvo en los casos en que
        exista una obligación legal. Usted tiene derecho a obtener confirmación
        sobre si en SOCIAL LINKS estamos tratando sus datos personales por tanto
